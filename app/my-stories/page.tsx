      ...
      <div className="container max-w-6xl mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              {generatingStories.map((story) => (
                <div key={story.id} className="bg-blue-950/50 border border-blue-700/30 rounded-lg p-4">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              {failedStories.map((story) => (
                <div key={story.id} className="bg-red-950/50 border border-red-700/30 rounded-lg p-4">
                  <div className="flex items-center gap-3">
        ...
        <div>
          ...
          {completedStories.length === 0 && generatingStories.length === 0 && failedStories.length === 0 ? (
            <div className="bg-gray-900/50 border border-rose-900/30 rounded-xl shadow-lg p-12 text-center">
            ...
            <div className="bg-gray-900/50 border border-rose-900/30 rounded-xl shadow-lg p-8 text-center">
              <p className="text-gray-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {completedStories.map((story) => (
                <Link
                  key={story.id}
                  href={`/stories/${story.id}`}
                  className="bg-gray-900/50 border border-rose-900/30 rounded-lg shadow-md hover:shadow-xl transition-shadow overflow-hidden group"
                >
                  {/* Cover Image */}
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="font-bold text-white mb-1 line-clamp-2 group-hover:text-rose-600 transition-colors">
                      {story.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {story.tags?.split(',').slice(0, 2).map((tag, i) => (
                        <span
                          key={i}
                          className="text-xs text-gray-400 bg-slate-100 px-2 py-0.5 rounded"
                        >
                          {tag.trim()}
                        </span>
                      ))}
