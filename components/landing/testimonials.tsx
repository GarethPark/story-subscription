      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {(title || subtitle) && (
          <div className="text-center mb-16">
            {title && (
              <>
                <Heart className="h-8 w-8 text-rose-500 fill-rose-500 mx-auto mb-4" />
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black bg-gradient-to-r from-rose-400 via-pink-300 to-violet-400 bg-clip-text text-transparent font-['Playfair_Display'] mb-4">
                  {title}
                </h2>
              </>
            )}
